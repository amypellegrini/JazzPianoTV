  ...
  return (
    <div className="jptv-landing-page font-large-size">
      <section>
        ...
        <p><strong>The Hanon Pilgrimage to Mastery</strong> is intended to be used in conjunction with <Link to="/jptv-12-rules" className="jptv-12-rules-link" label="JazzPianoTV 12 Rules for Piano Mastery"/>, as a framework for personal and technical development of Piano Mastery.</p>
