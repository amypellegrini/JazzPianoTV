  ...
  return (
    <div className="jptv-landing-page font-large-size">
      <section>
        ...
        <p>We could think about <strong>The Hanon Pilgrimage to Mastery</strong>, <strong>The Book of Triads</strong>, or <strong>A Crush Course on JazzPiano</strong> as the road to travel, and the <strong>JazzPianoTV 12 Rules for Piano Mastery</strong> as the guideline to make sure you are well prepared for the trip.</p>
