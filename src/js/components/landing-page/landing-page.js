  ...
  return (
    <div className="jptv-landing-page">
      <section>
        ...
        <p>Being a talented person is not enough. Understanding technique is not enough.</p>
        <p>Being disciplined, if not balanced with acute awareness, inner clarity, emotional stability, and deep understanding of technique, is not gonna cut it.</p>
